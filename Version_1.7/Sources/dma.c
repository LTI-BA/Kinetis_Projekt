...
// Configuring the DMA Channels 6 and 7 for the current values coming from ADC1
		...
		// ******************************************************************************************************************
			...
			DMA_TCD7_CITER_ELINKYES = (DMA_CITER_ELINKYES_ELINK_MASK | DMA_CITER_ELINKYES_LINKCH(6) | 0x04);
			...
			DMA_TCD7_BITER_ELINKYES  =(DMA_CITER_ELINKYES_ELINK_MASK | DMA_BITER_ELINKYES_LINKCH(6) | 0x04);
			...
			DMA_TCD7_CSR = DMA_CSR_INTMAJOR_MASK | DMA_CSR_MAJORELINK_MASK | DMA_CSR_MAJORLINKCH(6);
