...
void FTM_protect_init() {
	...
	CMP0_DACCR = CMP_DACCR_DACEN(1) | CMP_DACCR_VRSEL(0) | CMP_DACCR_VOSEL(21);
	...
	CMP1_DACCR = CMP_DACCR_DACEN(1) | CMP_DACCR_VRSEL(0) | CMP_DACCR_VOSEL(2);
	...
	FTM0_MODE |= FTM_MODE_WPDIS_MASK | FTM_MODE_FAULTM(2);
...
//  match value for the output modes for all the channels
	FTM0_C0V = (a * 170) / 10000000; //  match value for the output modes (CH0)
	FTM0_C1V = (a * 170) / 10000000; //  match value for the output modes (CH1)
	FTM0_C2V = (a * 170) / 10000000; //  match value for the output modes (CH2)
	FTM0_C3V = (a * 170) / 10000000; //  match value for the output modes (CH3)
	FTM0_C4V = (a * 170) / 10000000; //  match value for the output modes (CH4)
	FTM0_C5V = (a * 170) / 10000000; //  match value for the output modes (CH5)
	FTM0_C6V = (a * 170) / 10000000; //  match value for the output modes (CH6)
	FTM0_C7V = (a * 170) / 10000000; //  match value for the output modes (CH7)
}
...
void PWM_deadtime_enable(void) {
	FTM0_COMBINE |= FTM_COMBINE_DTEN0_MASK | FTM_COMBINE_DTEN1_MASK
...
void PWM_init(void) {
	...
	// alt 1 for PTA13 (yellow led) for overvoltage
	PORTA_PCR13 = PORT_PCR_MUX(1) | PORT_PCR_DSE(0);
	// alt 1 for PTA5 (green led)  for overcurrent
	PORTA_PCR5 = PORT_PCR_MUX(1) | PORT_PCR_DSE(0);

	// Set direction : output
	// disable pin
	GPIOD_PDDR |= (1 << 3);
	// overvoltage led output (yellow) PTA13
	GPIOA_PDDR |= (1 << 13);
	// overcurrent led output (green)  PTA5
	GPIOA_PDDR |= (1 << 5);
	...
	FTM0_C0SC = (FTM_CnSC_MSB(1) | FTM_CnSC_MSA(0) | FTM_CnSC_ELSB(0)
			| FTM_CnSC_ELSA(1));
	FTM0_C1SC = (FTM_CnSC_MSB(1) | FTM_CnSC_MSA(0) | FTM_CnSC_ELSB(0)
			| FTM_CnSC_ELSA(1));
	FTM0_C2SC = (FTM_CnSC_MSB(1) | FTM_CnSC_MSA(0) | FTM_CnSC_ELSB(0)
			| FTM_CnSC_ELSA(1));
	FTM0_C3SC = (FTM_CnSC_MSB(1) | FTM_CnSC_MSA(0) | FTM_CnSC_ELSB(0)
			| FTM_CnSC_ELSA(1));
	FTM0_C4SC = (FTM_CnSC_MSB(1) | FTM_CnSC_MSA(0) | FTM_CnSC_ELSB(0)
			| FTM_CnSC_ELSA(1));
	FTM0_C5SC = (FTM_CnSC_MSB(1) | FTM_CnSC_MSA(0) | FTM_CnSC_ELSB(0)
			| FTM_CnSC_ELSA(1));
	FTM0_C6SC = (FTM_CnSC_MSB(1) | FTM_CnSC_MSA(0) | FTM_CnSC_ELSB(0)
			| FTM_CnSC_ELSA(1));
	FTM0_C7SC = (FTM_CnSC_MSB(1) | FTM_CnSC_MSA(0) | FTM_CnSC_ELSB(0)
			| FTM_CnSC_ELSA(1));
	...
	FTM0_COMBINE |= FTM_COMBINE_COMP0_MASK | FTM_COMBINE_COMP1_MASK
			| FTM_COMBINE_COMP2_MASK | FTM_COMBINE_COMP3_MASK |
	...
	FTM0_SYNCONF |= FTM_SYNCONF_SYNCMODE_MASK | FTM_SYNCONF_SWWRBUF_MASK
