...
*/
	...
	monitorvars[fill].type=MCU_TRACER_DATA_TYPE_FLOAT;
	monitorvars[fill].rw=1;
	monitorvars[fill].data_f=&actual_error2;
	strcpy(monitorvars[fill].varname,"Actual error 2");
	monitorvars[fill].data_fmin=0;
	...
	monitorvars[fill].type=MCU_TRACER_DATA_TYPE_FLOAT;
	monitorvars[fill].rw=1;
	monitorvars[fill].data_f=&integral_error2;
	strcpy(monitorvars[fill].varname,"Integral error 2");
	monitorvars[fill].data_fmin=0;
	monitorvars[fill].data_fmax=1;
	fill++;
	...
	monitorvars[fill].type=MCU_TRACER_DATA_TYPE_FLOAT;
	monitorvars[fill].rw=1;
	monitorvars[fill].data_f=&duty_c2;
	strcpy(monitorvars[fill].varname,"Duty cycle Regulator 2");
	monitorvars[fill].data_lmin=0;
	monitorvars[fill].data_lmax=100000000;
	fill++;
	...
	monitorvars[fill].type=1;
	monitorvars[fill].rw=0;
	monitorvars[fill].data_f=&start_order;
	strcpy(monitorvars[fill].varname,"Start");
	monitorvars[fill].data_lmin=0;
	monitorvars[fill].data_lmax=1;
	fill++;
