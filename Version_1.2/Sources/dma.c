...
// Configuring the DMA Channels 2 and 3 for the current values coming from ADC1
		...
		// ******************************************************************************************************************
			...
			DMA_TCD3_SADDR = (uint32_t) &ADC1_RA;

			//**** Destination address, SRAM buffer [0]
			DMA_TCD3_DADDR = (uint32_t)&cu[0];
			...
			DMA_TCD3_CITER_ELINKYES = (DMA_CITER_ELINKYES_ELINK_MASK | DMA_CITER_ELINKYES_LINKCH(2) | 0x04);
			...
			DMA_TCD3_BITER_ELINKYES  =(DMA_CITER_ELINKYES_ELINK_MASK | DMA_BITER_ELINKYES_LINKCH(2) | 0x04);
			...
			DMA_TCD3_CSR = DMA_CSR_INTMAJOR_MASK | DMA_CSR_MAJORELINK_MASK | DMA_CSR_MAJORLINKCH(2);


			//**** Channel 3 transfers ADC1 result data from ADC1_RA to SRAM buffer.
			//**** Enable Channel 3 and set ADC1 as DMA request source (source number 41)
			DMAMUX_CHCFG3 = DMAMUX_CHCFG_ENBL_MASK | DMAMUX_CHCFG_SOURCE(41);


			//**** Channel 2 transfers next ADC1 input setting from constant buffer to ADC1_SC1A.
		    //**** DMA transfer request source - always requestor
			DMAMUX_CHCFG2 = DMAMUX_CHCFG_ENBL_MASK | DMAMUX_CHCFG_SOURCE(63) ;
...
// Configuring the DMA Channels 0 and 1 for the voltage values coming from ADC0
      ...
      // ******************************************************************************************************************
        ...
        //*** Enable Channel 1 and set ADC0 as DMA request source (source number 40)
      	...
      	DMA_TCD1_CITER_ELINKYES = (DMA_CITER_ELINKYES_ELINK_MASK | DMA_CITER_ELINKYES_LINKCH(0) | 0x05);

      	//**** Channel linking and major loop setting, linking after minor loop is enabled to
      	//**** channel 0 (0x0000), major loop transfers number 5 (0x05)
      	DMA_TCD1_BITER_ELINKYES  =(DMA_BITER_ELINKYES_ELINK_MASK | DMA_BITER_ELINKYES_LINKCH(0) |0x05);
        ...
        //**** Enable request signal for channel 1 and 3
        DMA_ERQ = DMA_ERQ_ERQ3_MASK | DMA_ERQ_ERQ1_MASK ;
